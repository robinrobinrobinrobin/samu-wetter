  ...
  <div class="p-6 text-2xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8 mb-32">
    ...
    <div>
      ...
      <p>
        ...
        Überzeugt vom Konzept geht es an die Projektplanung!
      </p>
    </div>
    <div>
      ...
      <p>
        ...
        geht es endlich ans Eingemachte: Shooting-time!
      </p>
    </div>
    <div>
      ...
      <p>
        ...
        Menge Spass mit sich! … Bis alles im Kasten ist.
      </p>
    </div>
    <div>
    ...
    <div>
      ...
      <p>
        ...
        wir eure Wunsch-Zielgruppe bestmöglich erreichen.
      </p>
    </div>
  </div>
</template>
